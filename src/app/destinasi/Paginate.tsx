...
export default function Paginate() {
  return (
    <div className="paginate flex justify-end text-[#878787] font-medium gap-[23px]">
      ...
      <button className="px-[10px] flex items-center justify-center text-sm rounded-[3px] [box-shadow:0px_0px_8px_0px_rgba(0,0,0,0.10)]">
        9 / Page
      </button>
    </div>
  );
